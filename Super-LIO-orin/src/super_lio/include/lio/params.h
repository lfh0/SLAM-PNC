...
namespace LI2Sup{
  ...
  extern std::vector<float> g_lidar_repub_robot_size;
  extern float g_lidar_repub_minz;
  extern float g_lidar_repub_maxz;
  extern float g_lidar_repub_danger_box_r;
  extern std::vector<float> g_lidar_repub_danger_box_z;
