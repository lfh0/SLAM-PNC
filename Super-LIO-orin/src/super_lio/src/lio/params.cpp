...
namespace LI2Sup{
  ...
  std::vector<float> g_lidar_repub_robot_size;
  float  g_lidar_repub_minz = -std::numeric_limits<float>::infinity();
  float  g_lidar_repub_maxz = std::numeric_limits<float>::infinity();
  float  g_lidar_repub_danger_box_r = 0.0f;
  std::vector<float> g_lidar_repub_danger_box_z;
