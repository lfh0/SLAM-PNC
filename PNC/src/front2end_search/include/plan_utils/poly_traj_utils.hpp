...
namespace plan_utils
{
    ...
    public:
        ...
        // {
        //     Eigen::Vector2d sigma = getPos(t);
            
        //     return std::atan2(singul * sigma(1), singul * sigma(0));
        // }
        ...
        {
            return std::atan(0.66 * getCurv(t));  //[-PI/2, PI/2]
        }
